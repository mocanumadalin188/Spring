...
import com.example.beans.pojo.AnotherSingletonBean;
...
public class SingletonContainingPrototypeRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info(String.valueOf(anotherSingletonBean1.hashCode()));
        log.info(String.valueOf(anotherSingletonBean2.hashCode()));
        log.info(String.valueOf(anotherSingletonBean1.getAnotherPrototypeBean().hashCode()));
        log.info(String.valueOf(anotherSingletonBean2.getAnotherPrototypeBean().hashCode()));
